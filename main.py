...
# add and in between consecutive non-terminals
...
# converts a list of strings representing CFG rules into a dictionary format
...
# finds indices of specific character
...
# This function generates combinations of strings by removing specific indices
...
# check if all production are terminals
def done(CFG):
